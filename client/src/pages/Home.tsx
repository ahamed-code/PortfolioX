        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              ...
              >
                <div className={`bg-gradient-to-br ${project.color} p-6 rounded-xl shadow-2xl flex flex-col items-center`}>
                  <div className="text-6xl mb-4 w-20 h-20 flex items-center justify-center">
                    {project.image}
                  </div>
